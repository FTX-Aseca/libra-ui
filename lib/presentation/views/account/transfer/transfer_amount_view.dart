...
class TransferAmountView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TransferAmountView> createState() =>
      _TransferAmountScreenState();
}

class _TransferAmountScreenState extends ConsumerState<TransferAmountView> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.operationType == OperationType.transfer
        ? balanceAsync.when(
            data: (balance) {
              _balance = balance;
              return Padding(
